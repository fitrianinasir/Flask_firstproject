...
video_up_args.add_argument("name", type=str, help="Name of the video is required")
video_up_args.add_argument("views", type=str, help="Views of the video is required")
video_up_args.add_argument("likes", type=str, help="Likes on the video is required")
